...
describe Decidim::Elections::Voter::CastVote do
  subject { described_class.new(form, bulletin_board_client: bulletin_board_client) }
  let(:form) do
    double(valid?: valid, encrypted_vote: { question_1: "aNsWeR 1" }, election: election)
  end
  let(:valid) { true }
